...
public class ObjectArrayListMenuLab05 {
    ...
    public  void addNumberIntoArrayList(List<Integer> arrList) {
        /*
         * int addMore;
         * do :
    ...
    public  void printArrayList(List<Integer> arrList) {
        System.out.println("Array is: " + arrList);
    }

    public  void printEachNumber(List<Integer> arrList) {
    ...
    public  Integer getMaxNum(List<Integer> arrList) {
        int maxNum;
    ...
    public  Integer getMinNum(List<Integer> arrList) {
        int minNum;
        SortedSet<Integer> sortedSetArrList = new TreeSet<>(arrList);
        List<Integer> ascStoredArrList = new ArrayList<>(sortedSetArrList);
    ...
    public  void searchNumber(List<Integer> storedArrList) {
